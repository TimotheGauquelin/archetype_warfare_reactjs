...
interface MultiSelectInputProps {
  ...
  array: string[];
  data: { roles?: string[] };
  setAction: React.Dispatch<React.SetStateAction<{ roles: string[] }>>;
}

const MultiSelectInput: React.FC<MultiSelectInputProps> = ({ colSpanWidth, label, required, array, data, setAction }) => {
