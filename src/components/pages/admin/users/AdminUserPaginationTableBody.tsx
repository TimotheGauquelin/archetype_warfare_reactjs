...
interface AdminUserPaginationTableBodyProps {
  arrayItems: User[];
  setRefresh: React.Dispatch<React.SetStateAction<boolean>>;
}

const AdminUserPaginationTableBody: React.FC<AdminUserPaginationTableBodyProps> = ({ arrayItems, setRefresh }) => {
      ...
      {arrayItems?.map((item, index) => {
        return (
          ...
          >
            ...
            <div className="h-full col-span-3 p-4 bg-gray-100 text-right">
              <p
