interface AdminArchetypeSwitchButtonsProps {
  setAlertDisplay?: () => void;
  setDisplayInformation: (value: string) => void;
  location: { state?: { request?: string } };
  actionBanlist?: () => void;
}

const AdminArchetypeSwitchButtons: React.FC<AdminArchetypeSwitchButtonsProps> = ({
