...
interface AdminHeaderProps {
  ...
  setDisplayedNavbar: React.Dispatch<React.SetStateAction<boolean>>;
  adminName?: string;
}

const AdminHeader: React.FC<AdminHeaderProps> = ({ displayedNavbar, setDisplayedNavbar }) => {
